	...
	var WebApi = (function () {
		function WebApi(options) {
			...
			this.webChannel.onConnectionSucceed = function () {
				_instance.onConnectionSucceed();
			};
			this.webChannel.onConnectionFailed = function () {
				_instance.onConnectionFailed();
			};
			this.webChannel.onDataReceivedTxt = function (data) {
				_instance.onDataReceivedTxt(data);
			};
		}
		WebApi.prototype.enumerateDevices = function () {
			...
			return new Promise(function (resolve, reject) {
				...
				if (_instance.webChannel.isConnected()) _instance.processQueue();
				else _instance.webChannel.connect();
			});
		};
		...
		WebApi.prototype.processQueue = function () {
			for (var i = 0; i < this.requests.length; i++) {
				if (this.requests[i].sent) continue;
