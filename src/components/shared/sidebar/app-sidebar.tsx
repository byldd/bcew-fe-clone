...
import { applyNavOrder } from "@/module/admin/utils/sidebar-reorder";
...
const AppSidebar = ({ items, ...props }: AppSidebarProps) => {
	...
	const permittedItems = applyNavOrder(filteredItems, user?.navOrder);
