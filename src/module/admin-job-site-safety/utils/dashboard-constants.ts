...
export const SAFETY_REPORT_STATUS_META: Record<SAFETY_REPORT_STATUS, { label: string; className: string }> = {
	...
	[SAFETY_REPORT_STATUS.PENDING]: { label: "Pending", className: "bg-amber-50 text-amber-600" },
	...
	[SAFETY_REPORT_STATUS.RESOLVED]: { label: "Resolved", className: "bg-green-50 text-green-600" },
};
...
export const MARK_READY_FOR_INSURANCE_CONFIRM = {
	title: "Do you want to Mark it Ready for Insurance?",
