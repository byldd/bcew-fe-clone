	...
	return (
		<div className="flex min-h-screen flex-col bg-brand-bgLightgrey px-6 pb-8 pt-16">
			<div className="flex flex-1 flex-col items-center">
				...
				<p className="mt-1 text-center text-xs text-gray-400">Crate #{summary.assetId} has been logged for return.</p>

				<div className="mt-6 w-full max-w-xs divide-y divide-gray-100 rounded-xl border border-gray-100 bg-white">
