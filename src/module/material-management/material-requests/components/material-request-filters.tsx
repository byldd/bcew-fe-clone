...
import type { FilterSelectPopoverProps, MaterialRequestFiltersProps } from "../utils/types";
import { ALL_VALUE, PHASE_OPTIONS } from "../utils/constants";
import { ChevronDown, PlusIcon, Star, StarOff, Trash2, X } from "lucide-react";
...
function FilterSelectPopover({ label, value, options, onApply, triggerClassName }: FilterSelectPopoverProps) {
	...
	const nonAllOptions = useMemo(() => options.filter((o) => o.value !== ALL_VALUE), [options]);
